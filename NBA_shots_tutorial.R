# =============================================================================
# NBA Shot Chart Tutorial
# Converted from NBA_Shots_Tutorial.Rmd
# Original Author: @DSamangy
# =============================================================================
...
# If you do not have the packages loaded, uncomment and run to install
...
# install.packages("magick")  # needed for draw_image()
library(magick)
...
# =============================================================================
# EXAMPLE 1: SINGLE GAME FOR A PLAYER
# =============================================================================

# Load the Dataset
# NOTE: Update path to your data location
shots_data <- read_csv("data/shot_location/NBA_2023_Shots.csv")
...
plot_court(court_themes$white, use_short_three = F) +
  ...
  # plot player headshot (remove these 2 lines if you're plotting multiple players!)
...
# =============================================================================
# EXAMPLE 2: SINGLE GAME FOR A TEAM
# =============================================================================
