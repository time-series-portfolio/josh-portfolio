...
ny_trends_grid <- gridExtra::grid.arrange(p1, p2, p3, p4, ncol = 2)

# Save for presentation
ggsave("images/ny_betting_trends.png", plot = ny_trends_grid, width = 14, height = 10, dpi = 300, bg = "white")
...
p_covid_impact <- ggplot(sports_covid, aes(x = date, y = Y)) +
    ...
    labs(
        title = "Google Searches for 'Sports Betting' (2020-2024)",
        subtitle = "Public interest trends in sports betting over time",
        x = "Date", y = "Search Interest (0-100)"
    ) +
