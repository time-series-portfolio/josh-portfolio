...
The recovery trajectory was uneven. When leagues resumed play in the NBA "bubble" and NFL returned in fall 2020, betting interest rebounded faster than attendance. This makes sense because people could bet on games from home, but couldn't attend empty arenas. By 2023-2024, attendance had partially recovered but remained below pre-pandemic levels, while betting markets had fully recovered and expanded. The pandemic accelerated a trend already underway, the shift from in-person attendance to digital engagement.

Our analysis also examined New York's January 2022 legalization of online sports betting, the largest market entry in U.S. history. The intervention analysis shows this produced a measurable but complex effect. Particularly an immediate surge in search interest followed by gradual normalization as the novelty faded. Sports betting is becoming mainstream entertainment rather than a niche activity, and regulatory changes are the driving force.
...
This analysis highlights three broader lessons: 

1. Data-driven optimization takes time to diffuse, as seen in the decades-long lag between the mathematical case for three-pointers and league-wide adoption
2. External shocks expose hidden system dependencies, with COVID revealing how tightly sports betting and fan engagement rely on live competition
3. Complex systems often favor simpler models, since advanced deep learning did not outperform traditional statistical forecasting for basketball data. 

Together, these insights show that NBA teams must continue innovating to stay competitive, the betting industry is shifting toward more sustainable long-term models, and data scientists can use time series analysis to uncover causal patterns across many domains. Basketball in 2025 is a data-optimized global product shaped by analytics, technology, and disruption.
